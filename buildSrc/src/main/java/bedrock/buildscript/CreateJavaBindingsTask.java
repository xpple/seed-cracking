...
public abstract class CreateJavaBindingsTask extends Exec {
...

    {
        ...
        this.commandLine("./jextract/build/jextract/bin/jextract" + EXTENSION, "--include-dir", "src/main/c", "--output", "src/main/java", "--use-system-load-library", "--target-package", "bedrock.generated", "--header-class-name", "BedrockNative", "@includes.txt", "blocks.h");
    }
}
